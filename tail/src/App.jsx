  ...
  return (
    ...
    <div class="h-screen flex flex-col justify-between">
      <div class="flex justify-between items-center">
        ...
        <div class="w-52 h-52 flex bg-purple-950">
          <div class="w-17 h-17 flex self-start bg-purple-300"></div>
          <div class="w-17 h-17 flex self-end bg-purple-300"></div>
        </div>
      ...
      <div class="flex justify-between items-center">
        ...
        <div class="w-52 h-52 flex flex-row bg-purple-950">
          <div class="w-17 h-17 self-start bg-purple-300"></div>
          <div class="w-17 h-17 self-end bg-purple-300"></div>
          <div class="w-17 h-17 self-start bg-purple-300"></div>
          <div class="w-17 h-17 self-end bg-purple-300"></div>
        </div>
        <div class="w-52 h-52 justify-center flex bg-purple-950">
